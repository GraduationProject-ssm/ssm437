...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=35)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本物流管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让医生管理信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，物流管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，物流管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|cheliang\_name|String|车牌|是|
|3|xinghao\_types|Integer|车辆型号|是|
|4|goumai\_time|Date|购买时间|是|
|5|cheliang\_money|BigDecimal|车辆价格|是|
|6|cheliang\_changjia|String|生产厂家|是|
|7|cheliang\_phone|String|联系电话|是|
|8|cheliang\_dizhi|String|联系地址|是|
...
|14|super\_types|Integer|父字段id|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|16|news\_name|String|公告信息名称|是|
|17|news\_photo|String|公告信息图片|是|
|18|insert\_time|Date|公告信息时间|是|
|19|news\_content|String|公告信息详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|21|cheliang\_id|Integer|运输车辆|是|
|22|yunshuchengben\_id|Integer|承运单号|是|
|23|chengyun\_time|Date|承运时间|是|
|24|jieshou\_time|Date|接收时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|26|shiji\_name|String|司机名称|是|
|27|jiazhao\_types|Integer|驾照类型|是|
|28|ruzhi\_time|Date|入职时间|是|
|29|shiji\_phone|String|联系方式|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|37|yunshuchengben\_id|Integer|承运单号|是|
|38|yundanzhuangtai\_gongsi|String|目前状态|是|
|39|update\_time|Date|更新时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|41|yunshuchengben\_name|String|承运单号|是|
|42|xinghao\_types|Integer|车辆型号|是|
|43|ruzhi\_time|Date|承运时间|是|
|44|yunshuchengben\_money|BigDecimal|承运价格|是|
|45|yunshuchengben\_gongsi|String|承运公司|是|
|46|yunshuchengben\_phone|String|联系方式|是|
|47|yunshuchengben\_dizhi|String|联系地址|是|
...
图5.2 车辆信息管理页面
### 5.3司机信息管理
如图5.3显示的就是司机信息管理页面，此页面提供给管理员的功能有：根据司机信息进行条件查询，还可以对司机信息进行新增、修改、查询操作等等。
